...
namespace OpenXmlPowerTools.SpreadsheetWriter
{
    ...
    public static class SpreadsheetWriter
    {
        ...
        private static void AddWorksheet(SpreadsheetDocument sDoc, Worksheet worksheetData)
        {
            ...
            using (Stream partStream = worksheetPart.GetStream(FileMode.Create, FileAccess.Write))
            {
                using (XmlWriter partXmlWriter = XmlWriter.Create(partStream))
                {
                    ...
                    partXmlWriter.WriteAttributeString("xml", "space", null, "preserve");
                    ...
                    SerializeRows(sDoc, partXmlWriter, worksheetData.Rows, numColumnHeadingRows + 1, out int numColumnsInRows,
                        out int numRows);
                    ...
                    if (worksheetData.ColumnHeadings != null && worksheetData.TableName != null)
                    {
                        ...
                        XElement table = new XElement(S.table,
                            ...
                            new XElement(S.tableStyleInfo,
                                new XAttribute(SSNoNamespace.name, "TableStyleLight13"),
            ...
            int startingRowNumber, out int numColumns, out int numRows)
        {
            ...
            {
                SerializeRow(sDoc, xmlWriter, rowNumber, row, out int localNumColumns);
