        ...
        private static void AddWorksheet(SpreadsheetDocument sDoc, Worksheet worksheetData)
        {
            ...
            using (Stream partStream = worksheetPart.GetStream(FileMode.Create, FileAccess.Write))
            {
                using (XmlWriter partXmlWriter = XmlWriter.Create(partStream))
                {
                    ...
                    {
                    partXmlWriter.WriteStartElement("cols", ws);

                    foreach (Column col in worksheetData.Columns)
                    {
                        partXmlWriter.WriteStartElement("col", ws);

                        partXmlWriter.WriteStartAttribute("min");
                        partXmlWriter.WriteValue(col.Min+1);
                        partXmlWriter.WriteEndAttribute();

                        partXmlWriter.WriteStartAttribute("max");
                        partXmlWriter.WriteValue(col.Max+1);
                        partXmlWriter.WriteEndAttribute();

                        partXmlWriter.WriteStartAttribute("width");
                        partXmlWriter.WriteValue(col.Width);
                        partXmlWriter.WriteEndAttribute();

                        partXmlWriter.WriteStartAttribute("style");
                        partXmlWriter.WriteValue(col.Style );
                        partXmlWriter.WriteEndAttribute();

                        partXmlWriter.WriteStartAttribute("customWidth");
                        partXmlWriter.WriteValue((col.CustomWidth != null && col.CustomWidth==true)?1:0);
                        partXmlWriter.WriteEndAttribute();
                    ...
                    partXmlWriter.WriteAttributeString("ref", "A1:" + SpreadsheetMLUtil.IntToColumnId(worksheetData.ColumnHeadings.Count()-1) + (worksheetData.Rows.Count()+1).ToString()); 
                    partXmlWriter.WriteEndElement();

                    partXmlWriter.WriteStartElement("sheetViews", ws);
                    partXmlWriter.WriteStartElement("sheetView", ws);
                    partXmlWriter.WriteAttributeString("tabSelected", "1");
                    partXmlWriter.WriteAttributeString("workbookViewId", "0");
                   
                    partXmlWriter.WriteStartElement("pane", ws);
                    partXmlWriter.WriteAttributeString("xSplit", "1");
                    partXmlWriter.WriteAttributeString("ySplit", "1");
                    partXmlWriter.WriteAttributeString("topLeftCell", "B2");
                    partXmlWriter.WriteAttributeString("activePane", "bottomRight");
                    partXmlWriter.WriteAttributeString("state", "frozen");
                    partXmlWriter.WriteEndElement();


                    partXmlWriter.WriteStartElement("selection", ws);
                    partXmlWriter.WriteAttributeString("pane", "topRight");
                    partXmlWriter.WriteAttributeString("activeCell", "B1");
                    partXmlWriter.WriteAttributeString("sqref", "B1");
                    partXmlWriter.WriteEndElement();

                    partXmlWriter.WriteStartElement("selection", ws);
                    partXmlWriter.WriteAttributeString("pane", "bottomLeft");
                    partXmlWriter.WriteAttributeString("activeCell", "A2");
                    partXmlWriter.WriteAttributeString("sqref", "A2");
                    partXmlWriter.WriteEndElement();

                    partXmlWriter.WriteStartElement("selection", ws);
                    partXmlWriter.WriteAttributeString("pane", "bottomRight");
                    partXmlWriter.WriteAttributeString("activeCell", "B2");
                    partXmlWriter.WriteAttributeString("sqref", "B2");
                    partXmlWriter.WriteEndElement();
