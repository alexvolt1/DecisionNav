...
{
    public partial class RelReport3 : System.Web.UI.Page
    {
        ...
        private static IRelationalReport GetReport(string id)
        {
            ...
            if (rr == null)
            {
                ...
                rr.Connect.DATAConnectionString = @"Data Source=RRYVKIN10L;Initial Catalog=BBT_Even;Integrated Security=SSPI;Connect Timeout=240";
