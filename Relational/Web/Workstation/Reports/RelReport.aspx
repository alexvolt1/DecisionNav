<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RelReport.aspx.cs" Inherits="Relational.Workstation.Reports.RelReport" %>
<!DOCTYPE html>
   ...
   <div id="filterselect"></div>   
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                relreport.init(reportid);
                   
                $("#Img2").on("click", function () {
                    var w =  window.open("RelToExcel.ashx?id=<%=ReportId%>","", "width=700,height=150");
                      
                        //window.open("RelToExcel.ashx?id=<%=ReportId%>", '_blank');   
                        //location.href="RelToExcel.ashx?id=<%=ReportId%>";
                    });
            });
</script>
    <%if(isDebugging){ %>
