...
namespace RMToolsCreate
{
	...
	class QueryBuilder
	{
        ...
        /// <summary>
        /// Class to track group information
        /// </summary>
        ...
        private List<GroupInfo> _groupColumns = new List<GroupInfo>();
        ...
        /// <summary>
        /// Adds an GROUP BY column to the current query
        /// </summary>
        /// <param name="colName">Name of column used for grouping</param>
        public void AddGroupColumn(string colName)
        {
            _groupColumns.Add(new GroupInfo() { Name = colName, Table = null });
        }
        ...
        {
            return _top != null && _top != "" && _top !="0"? "top " + _top : "";
        }
        ...
        /// <summary>
        /// Constructs a string with a list of GROUP BY columns
        /// </summary>
        /// <returns></returns>
        protected string BuildGroupString()
        {
            ...
            StringBuilder builder = new StringBuilder();
            foreach (GroupInfo info in _groupColumns)
            {
                builder.Append(info.ToString(builder.Length == 0));
            }
