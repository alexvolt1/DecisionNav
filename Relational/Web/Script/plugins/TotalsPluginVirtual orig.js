...
TotalsPlugin.prototype.init = function (grid) {
  ...
  //this._$totalsViewport = $('<div class="slick-viewport totals-viewport">').css({ top: (this._rowHeight) * -1, width: width - this._scrollbarWidth });
  this._$totalsViewport = $('<div class="slick-viewport totals-viewport">').css({ top: (this._rowHeight + this._scrollbarWidth) * -1, width: width - this._scrollbarWidth });
...
TotalsPlugin.prototype._appendTotalsRow = function (grid) {
  ...
  var totals = this._totalsData;// grid.getData().getTotals();
